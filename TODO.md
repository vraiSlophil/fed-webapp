...
#18 Align user management UIs with backend /api/users contracts and admin role rules

#3 Align playground navigation with /api/playgrounds and /api/themes?playground_id=

#24 Migrate task UI and stats from doing to in_progress and PATCH task contracts

#25 Align theme sharing management with /api/users search, /api/invitations, and member PATCH/DELETE

#12 Build the authenticated /invite/[invitationId] deep-link flow
