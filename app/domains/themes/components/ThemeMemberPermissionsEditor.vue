...
// Composables
const { getCurrentPreset } = useThemeMembers();
                ...
                <div class="relative flex items-center gap-2">
                    ...
                    >
                        <span
                            ...
                            class="material-symbols-rounded text-sm mr-2"
                            >visibility</span
                        >
                        <span v-else class="material-symbols-rounded text-sm mr-2"
                            >visibility_off</span
                        >
                        Voir le thème
                    </Button>
