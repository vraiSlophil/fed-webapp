...
<template>
    ...
    >
        ...
        <Tabs value="0">
            <TabList>
                <Tab value="0" @click="onTabChange(0)">Membres </Tab>
                <Tab value="1" @click="onTabChange(1)">Inviter un membre </Tab>
            </TabList>
            <TabPanels>
                <TabPanel value="0">
                    <!-- Liste des membres -->
                    <div v-if="loading" class="text-center py-4">
                        <span
                            class="material-symbols-rounded text-neutral-400 !text-4xl animate-spin"
                        >
                            progress_activity
                        </span>
                ...
                <TabPanel value="1">
                    ...
                    <div>
                        ...
                        <div v-if="noResults" class="text-center text-neutral-500 py-4">
                            <p class="text-sm">
                                Aucun utilisateur trouvé. Essayez avec un autre terme de recherche.
                            </p>
                        </div>
        ...
        <ThemeMemberPermissionsEditor
            ...
            :permission-presets="permissionPresets"
            :title="
                editingMember ? `Permissions de ${getDisplayName(editingMember)}` : 'Permissions'
            "
            mode="edit"
        ...
        >
            <div v-if="memberToDeactivate">
                <p class="mb-4">
                    ...
                    {{ getDisplayName(memberToDeactivate) }} ? Cette personne ne pourra plus accéder
                    au thème.
                </p>
                <div class="flex gap-2 justify-end">
                    ...
                    <Button :loading="loading" outlined rounded @click="handleDeactivate">
                        Désactiver
                    </Button>
                </div>
            </div>
        ...
        >
            <div v-if="memberToDelete">
                <p class="mb-4">
                    ...
                    {{ getDisplayName(memberToDelete) }} ? Cette action est irréversible.
                </p>
                <div class="flex gap-2 justify-end">
                    <Button :disabled="loading" text rounded @click="showDeleteConfirm = false">
                        Annuler
                    </Button>
                    <Button
                        :loading="loading"
