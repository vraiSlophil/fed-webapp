                                ...
                                <template #body="{ data }">
                                    <div>
                                        <div class="flex items-center gap-1">
                                            ...
                                            <span
                                                v-if="data.first_name && data.last_name"
                                    ...
                                    <Tag
                                        ...
                                        :value="
                                            data.role.name.charAt(0).toUpperCase() +
                                                data.role.name.slice(1) || 'Utilisateur'
                                        "
                                    />
                                </template>
                            </Column>
                                ...
                                <template #body="{ data }">
                                    <div class="flex gap-1">
                                        ...
                                        <Tag
                                            ...
                                            value="Vérifié"
                                        />
                                        <Tag v-else severity="info" value="Non vérifié" />
                                    </div>
                                </template>
                            </Column>
                ...
                <TabPanel :disabled="!selectedUser" :value="1">
                    <div v-if="selectedUser" class="p-6">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            <!-- Profil utilisateur -->
                            <Card
                                class="lg:col-span-1 border-[1px] border-slate-200 dark:border-zinc-700"
                            >
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <Tag
                                                    ...
                                                    "
                                                    :value="
                                                        selectedUser.blocked_at ? 'Bloqué' : 'Actif'
                                                    "
                                                />
                                            </div>
                            ...
                            <Card
                                class="lg:col-span-2 border-[1px] border-slate-200 dark:border-zinc-700"
                            >
                                <template #title>
                                    <div class="flex items-center">
                                        <span
                                            class="material-symbols-rounded mr-2 text-gray-600 dark:text-gray-300"
                                        >
                                            analytics
                                        </span>
                                ...
                                <template #content>
                                    ...
                                    <div v-else class="flex flex-col gap-6">
                                        ...
                                        <div>
                                            ...
                                            <div class="grid grid-cols-2 gap-4">
                                                <div
                                                    class="text-center p-4 bg-cyan-50 dark:bg-cyan-900/20 rounded-lg"
                                                >
                                        ...
                                        <div>
                                            ...
                                            <div class="grid grid-cols-3 gap-3">
                                                <div
                                                    class="text-center p-3 bg-rose-50 dark:bg-rose-900/20 rounded-lg"
                                                >
                                                    <div class="text-lg font-bold text-rose-600">
                                                        {{
                                                            userMetrics.recent_activity
                                                                .tasks_last_7_days
                                                        }}
                                                    </div>
                                                    <div
                                                ...
                                                <div
                                                    class="text-center p-3 bg-teal-50 dark:bg-teal-900/20 rounded-lg"
                                                >
                                            ...
                                            <div class="grid grid-cols-2 gap-4">
                                                ...
                                                >
                                                    <div class="text-lg font-bold text-amber-600">
                                                        {{
                                                            userMetrics.average_tasks_per_theme.toFixed(
                                                                1,
                                                            )
                                                        }}
                                                    </div>
                                                    <div
                                                        class="text-sm text-gray-600 dark:text-gray-400"
                                                    >
                                                        Tâches par thème (moy.)
                                                    </div>
                                                </div>
                                                <div
                                                    class="text-center p-4 bg-lime-50 dark:bg-lime-900/20 rounded-lg"
                                                >
                                                ...
                                                <div
                                                    class="text-center p-4 bg-stone-50 dark:bg-stone-800 rounded-lg"
                                                >
                                        ...
                                        <div>
                                            ...
                                            <div class="grid grid-cols-2 gap-4">
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        v-if="userMetrics.blocked_since"
                                                        class="text-xs mt-1 text-red-600 dark:text-red-400"
                                                    >
                                                        Bloqué
                                                        {{ userMetrics.blocked_since }}
                                                    </div>
                                                </div>
                                                <div
                                                    :class="
                                                        userMetrics.is_email_verified
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        v-if="userMetrics.verified_since"
                                                        class="text-xs mt-1 text-blue-600 dark:text-blue-400"
                                                    >
                                                        Vérifié
                                                        {{ userMetrics.verified_since }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="confirmation-content flex items-center gap-3 m-4">
                ...
                <span>
                    ...
                    <span class="text-red-500 text-sm mt-2 block">
                        Cette action est irréversible et supprimera toutes les données associées à
                        cet utilisateur.
                    </span>
                </span>
            </div>
            <template #footer>
                <Button label="Annuler" outlined @click="deleteDialogVisible = false" />
                <Button
                    :loading="loading"
                    label="Supprimer"
                    severity="danger"
