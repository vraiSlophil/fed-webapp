                ...
                <div>
                    <div class="flex flex-col items-center space-y-2 mb-8">
                        ...
                        <FileUpload
                            ...
                            :auto="true"
                            :custom-upload="true"
                            :choose-label="avatarUploading ? 'Chargement...' : 'Changer d\'avatar'"
                ...
                <div>
                    ...
                    >
                        ...
                        <div>
                            ...
                            <Password
                                ...
                                class="w-full"
                                :input-class="'w-full !px-4 !rounded-full'"
                                toggle-mask
                            />
                        </div>
                        <div>
                    ...
                    <div class="mt-8 text-sm text-gray-600 space-y-1">
                        <div v-if="user.last_login_at">
                            Dernière connexion :
                            <span class="font-medium">{{ formatLastLogin }}</span>
                        </div>
                        <div v-if="user.last_login_ip">
                            IP de dernière connexion :
                            <span class="font-mono">{{ user.last_login_ip }}</span>
                        </div>
                    </div>
