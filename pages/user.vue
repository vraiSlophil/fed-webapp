...
<template>
  <div class="flex min-h-screen items-center justify-center flex-col">
    ...
    <div class="p-8 rounded shadow-md w-full max-w-sm space-y-4">
      ...
      <div v-if="user" class="flex flex-col items-center space-y-2">
        <div class="w-20 h-20 rounded-full bg-blue-200 flex items-center justify-center text-3xl font-bold text-blue-700">
